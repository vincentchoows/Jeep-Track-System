...
class Form extends Interactor
{
    ...
    {
        //TESTING
        // Check if the form is an instance of Interactor Form
        // if ($this->form instanceof \OpenAdmin\Admin\Actions\Interactor\Form) {
        //     // If it is, return the model associated with the form
        //     return $this->form->getModel();
        // }

        // // If it's not an instance of Interactor Form, return the form itself
        // return $this->form;
