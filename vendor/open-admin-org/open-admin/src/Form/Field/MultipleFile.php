...
class MultipleFile extends Field
{
    ...
    {
        $this->fileActionSettings['showDrag'] = false;
    ...
    public function render()
    {
        ...
        if (!is_array($this->value)) {
            ...
            $filePathsString = trim($string, '[]');
            $filePathsArray = explode(',', $filePathsString);

            // Remove any leading/trailing whitespace and remove surrounding double quotes
            $filePathsArray = array_map(function ($path) {
                return trim($path, '"');
            }, $filePathsArray);

            $this->value = $filePathsArray;
            // dd($this->value, $filePathsArray);
