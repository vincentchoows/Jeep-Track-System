...
class File extends Field
{
    ...
    protected function setupScripts()
    {
        ...
        $this->options['allPath'] = $this->data;
        // dd($this);

        // data-> surat indemnity 
        // config('filesystems.disks.admin.root') . '/' . $holderId

        

        // $this->options['filepath'] = config('filesystems.disks.admin') . $filepath ;
