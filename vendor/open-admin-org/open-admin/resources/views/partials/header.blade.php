...
<header class="custom-navbar navbar navbar-light bg-white p-0 align-items-stretch">
    <a class="navbar-brand menu-width container-md bg-semi-dark text-center" href="{{ admin_url('/') }}">
        <span class="short">{!! config('admin.logo-mini', config('admin.name')) !!}</span>
        <span class="long">
            <img src="{!! config('admin.logo', config('admin.name')) !!}" alt="Admin Logo" style="height: 50px;margin: 10px 10px;">
        </span>
    </a>
