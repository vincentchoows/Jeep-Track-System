...
class UploadedFile extends SymfonyUploadedFile
{
     ...
     * @return string|false
     */
    public function storeAs($path, $name = null, $options = [], $holderId=null)
    {
        if (is_null($name) || is_array($name)) {
            [$path, $name, $options] = ['', $path, $name ?? []];
        }
        ...
        return Container::getInstance()->make(FilesystemFactory::class)->putFileAs(
            $path, $this, $name, $options, $holderId
        );
    }
