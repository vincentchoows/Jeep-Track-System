...
class MediaManager extends Extension
{
    ...
    public function urls()
    {
        return [
            ...
            'view'      => config('filesystems.disks.admin.url')
        ];
    }
    ...
    public function formatFiles($files = [])
    {
        $files = array_map(function ($file) {
            return [
                ...
                'view'     => config('filesystems.disks.admin.url').$file,
            ];
        }, $files);
    ...
    public function formatDirectories($dirs = [])
    {
        ...
        $dirs = array_map(function ($dir) use ($preview,$url) {
            return [
                'download' => '',
                'icon'     => '',
                'name'     => $dir,
                ...
                'view' => config('filesystems.disks.admin.url') . $dir,
            ];
        }, $dirs);
